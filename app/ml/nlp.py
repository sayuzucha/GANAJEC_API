...
DISEASE_SYMPTOM_PROFILE = {
    "Healthy": set(),
    "Mastitis_Clinical": {"hinchazon_ubre", "fiebre", "baja_produccion_leche", "decaimiento"},
    "Mastitis_Subclinical": {"baja_produccion_leche", "hinchazon_ubre"},
    "Foot_and_Mouth": {"fiebre", "cojera", "ampollas_boca", "salivacion_excesiva", "lesiones_piel", "anorexia"},
    "Foot_Rot": {"cojera", "lesiones_piel", "fiebre"},
    "Laminitis": {"cojera", "decaimiento"},
    "Lameness_Clinical": {"cojera", "decaimiento", "anorexia"},
    "Pneumonia": {"fiebre", "tos", "dificultad_respiratoria", "secrecion_nasal", "decaimiento", "anorexia"},
    "Bovine_Respiratory_Disease": {"fiebre", "tos", "dificultad_respiratoria", "secrecion_nasal", "decaimiento"},
    "Diarrhea": {"diarrea", "decaimiento", "anorexia", "perdida_peso"},
    "Bloat": {"distension_abdominal", "decaimiento", "anorexia"},
    "Acidosis": {"distension_abdominal", "diarrea", "anorexia", "salivacion_excesiva"},
    "Anaplasmosis": {"fiebre", "decaimiento", "garrapatas", "perdida_peso", "anorexia"},
    "Babesiosis": {"fiebre", "decaimiento", "garrapatas", "anorexia"},
    "Internal_Parasites": {"diarrea", "perdida_peso", "decaimiento", "anorexia"},
    "Brucellosis": {"fiebre", "decaimiento", "ganglios_inflamados"},
    "Bovine_Tuberculosis": {"tos", "perdida_peso", "ganglios_inflamados", "decaimiento", "dificultad_respiratoria"},
    "Milk_Fever": {"debilidad_posparto", "temblores", "baja_produccion_leche", "decaimiento"},
    "Ketosis_Clinical": {"baja_produccion_leche", "anorexia", "aliento_cetonas", "decaimiento"},
    "Heat_Stress": {"dificultad_respiratoria", "baja_produccion_leche", "decaimiento", "anorexia"},
    "Anthrax": {"fiebre", "temblores", "hinchazon_cuello", "decaimiento"},
    "Black_Quarter": {"fiebre", "cojera", "hinchazon_cuello", "decaimiento"},
    "Haemorrhagic_Septicemia": {"fiebre", "hinchazon_cuello", "dificultad_respiratoria", "decaimiento"},
}
